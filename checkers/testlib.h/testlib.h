...
// exit codes for olymp.krsu.edu.kg
#define OK_EXIT_CODE 3
#define WA_EXIT_CODE 1
#define PE_EXIT_CODE 2
#define FAIL_EXIT_CODE 4
#define DIRT_EXIT_CODE 2
#define POINTS_EXIT_CODE 4
#define UNEXPECTED_EOF_EXIT_CODE 2
#define PC_BASE_EXIT_CODE 4
/*
#ifndef OK_EXIT_CODE
...
static bool __testlib_isNaN(double r)
{
    ...
    long long llnan = 0xFFF8000000000000ULL;
...
void registerTestlibCmd(int argc, char* argv[])
{
    ...
    inf.init(argv[1], _input);
    // we changed it for the sake of compatibility with olymp.krsu.edu.kg
